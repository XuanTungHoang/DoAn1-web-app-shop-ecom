...
<form  action="/page/product/add.php" method="POST" class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <input type="text" name="image" class="form-control" value="<?php if(!empty($_SESSION['input_product']['image'])){echo $_SESSION['input_product']['image'];} ?>">
    </div>
    <div class="form-group">
